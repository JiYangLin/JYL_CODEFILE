...
CString CShockwaveFlash::GetAllowFullScreenInteractive()
{
	CString result;
...
void CShockwaveFlash::SetAllowFullScreenInteractive(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
...
BOOL CShockwaveFlash::GetIsDependent()
{
	BOOL result;
...
void CShockwaveFlash::SetIsDependent(BOOL bNewValue)
{
	static BYTE parms[] =
		VTS_BOOL;
