...
BOOL CBitButtonNL::PreTranslateMessage(MSG* pMsg) 
{
...
void CBitButtonNL::CalcWindowRect(LPRECT lpClientRect, UINT nAdjustType) 
{
	// TODO: Add your specialized code here and/or call the base class
...
void CBitButtonNL::SetToolTipText(LPCTSTR lpszToolTipText)
{
	m_ToolTip.UpdateTipText(lpszToolTipText,   this);            //设置提示框内容
// 	m_ToolTip.SetTipBkColor(RGB(18,248,229));
